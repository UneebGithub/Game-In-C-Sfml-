...
int main()
{
    ...
    RenderWindow app(VideoMode(520, 450), "GAME BY UNEEB");
    app.setFramerateLimit(60);

    Texture t1,t2,t3,t4;
    t1.loadFromFile("images/waj.png");
    t2.loadFromFile("uneeb1.png");
    t3.loadFromFile("images/pl.png");
    t4.loadFromFile("images/bas.png");
